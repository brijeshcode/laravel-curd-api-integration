    ...
    export default defineComponent({
        ...
        props:['properties', 'propertyTypes'],
         data: () => ({
            ...
            breadcrums: [ {name: 'Api Properties'} ],
            tableHeads : ['#', 'County', 'Country', 'Town', 'Address', 'Postalcode', 'bedrooms','bathrooms', 'price', 'for', 'type' ],
            actionsLinks: [
              {title: 'Refresh', route: 'admin.properties.api_refresh', icon: 'add'}
            ],
         ...
         methods:{
          filterData(){
            Inertia.get(route('admin.properties.api'), this.filter ,{
                  preserveState: true,
                  replace: true
              });
          }
