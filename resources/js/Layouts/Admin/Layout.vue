...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('admin.properties.index')" :active="route().current('admin.properties.index')">
                                    Properties
                                </NavLink>

                                <NavLink :href="route('admin.properties.api')" :active="route().current('admin.properties.api')">
                                    API Data
                                </NavLink>

                                <NavLink :href="route('admin.property_types.index')" :active="route().current('admin.property_types.index')">
                                    Property Types
                                </NavLink>
                            </div>
                            ...
                            <!-- Properties Dropdown -->
                            <!-- <div class="hidden sm:flex sm:items-center sm:ml-6 sm:flex">
                            <div class="ml-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        <DropdownLink :href="route('admin.setups.properties.index')">
                                           Properties
                                        </DropdownLink>
                                    </template>
                                </Dropdown>
            ...
            <div class="max-w-7xl mx-auto mb-4 sm:px-6 lg:px-8" v-if="$slots.filtersData">
                <slot name="filtersData"></slot>
            </div>

            <div class="page-stats max-w-7xl mx-auto sm:px-6 lg:px-8" v-if="$slots.pageStats">
                <div class="hidden border-purple-400 bg-purple-400 border-yellow-400 border-green-400 border-blue-400 bg-blue-400 bg-green-400 bg-red-400 bg-yellow-400 "></div>
                <div class="flex flex-col md:flex-row lg:flex-row w-full md:space-x-2 md:space-y-0  lg:space-x-2 space-y-2 lg:space-y-0 mb-2 md:mb-2 lg:mb-4">
                    <slot name="pageStats"></slot>
                </div>
            </div>
