<template>
	...
	<div class="bg-white px-1 py-2 text-xs flex items-center justify-between border-t border-gray-200 sm:px-2">
		...
		<div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
		  <div>
		    <p class="text-xs text-gray-700" v-if="pageData.from && pageData.total && pageData.to">
		      Showing
		  ...
		  <div>
		    <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
		        <Component
		          ...
		          :href="link.url"
		          class="bg-white border-gray-300 text-gray-500 hover:bg-gray-50 hidden md:inline-flex relative items-center px-2 py-1 border text-xs font-medium"
